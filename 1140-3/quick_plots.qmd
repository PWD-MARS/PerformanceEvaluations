...
ggplot(ow1_comb, aes(x = dtime, y = cwlevel)) +
  ...
  geom_line(aes(linetype = "Water Level"), color = "cornflowerblue", linewidth = 1.2) +
  geom_hline(aes(yintercept = 1.08), color = "red", linewidth = 0.6) +
  geom_hline(yintercept = 5.83, linetype = "dashed") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  coord_cartesian(ylim = c(0, 6)) + 
  geom_vline(xintercept = ymd_hms("2025-05-16 12:00:00"), linetype = 2, color = "orange", linewidth = 0.5) +
  geom_vline(xintercept = ymd_hms("2025-05-30 12:00:00"), linetype = 2, color = "orange", linewidth = .5) +
  labs(
    title = "1440-3-1 OW1 Water Level Plot",
    y = "Date",
    x = "Water level (ft)",
    linetype = NULL
  )  +
