...
dash2_cs1paths <- imap(dash2_main, paste, "\\CS1\\", dash2_cs1Files, sep = "") |> unlist()

dash2_cs2Files <-list.files(paste(dash2_main, "\\CS2", sep = ""))

dash2cs2paths <- imap(dash2_main, paste,"\\CS2\\", dash2_cs2Files, sep = "") |> unlist()

dash2_cs1 <- map_dfr(dash2_cs1paths, read_qaqc)
```
