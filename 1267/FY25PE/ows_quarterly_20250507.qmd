...
cs1_wlvl <- dash2_cs1 |>
  ...
  mutate(cs1_adj_wlvl = water_level + (cs2_elev[["outflow_inv_12"]] - cs1_elev[["bottom_sensor"]])) |>
  select(dtime, cs1_adj_wlvl)

cs2_wlvl <- dash2_cs2 |>
  mutate(cs2_adj_wlvl = water_level + (cs2_elev[["outflow_inv_12"]] - cs2_elev[["bottom_sensor"]])) |>
  select(dtime, cs2_adj_wlvl)
