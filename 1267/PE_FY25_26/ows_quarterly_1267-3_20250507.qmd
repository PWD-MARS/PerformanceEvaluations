...
dash2_cs2 <- read_rds("data/1267-3_CS2_level.rds")
dash2_cs2 <- read_rds("data/1267-3_CS3_level.rds")

# Read rainfall CSV (rain should be the same as 1267-2)
