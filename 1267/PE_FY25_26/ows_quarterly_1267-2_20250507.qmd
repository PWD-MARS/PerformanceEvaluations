...
cs1_plot <- ggplot(ow_comb |> 
  ...
  geom_hline(aes(yintercept = cs1_adj$outflow_iso_inv_24),
             ...
             linetype = "dashed")  +
  annotate("text", x =  ymd_hms("2025-01-05 06:00:00"),
           y =  cs1_adj$outflow_iso_inv_24 - 0.3,
